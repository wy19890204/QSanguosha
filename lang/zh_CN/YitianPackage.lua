...
武器特效：1、你的回合外，你每受到一次伤害，在其结算完后你可以立即使用一张【杀】。2、当此剑从装备区失去时，你可用此剑指定一名其他角色受到你造成的1点无属性伤害",
	...
	["caochong"] = "曹冲",
	["chengxiang"] = "称象",
	[":chengxiang"] = "每当你受到一次伤害后，你可以弃置X张点数之和与造成伤害的牌的点数相等的牌，你可以选择至多X名角色，若其已受伤则回复1点体力，否则摸两张牌。",
	["@chengxiang-card"] = "请弃置点数之和为 %arg 的卡牌以发动“称象”技能",
	["~chengxiang"] = "选择若干张牌→选择若干名角色→点击确定",
	["conghui"] = "聪慧",
	...
	["zhangjunyi"] = "张儁乂",
	["jueji"] = "绝汲",
	[":jueji"] = "出牌阶段，你可以和一名角色拼点：若你赢，你获得对方的拼点牌。你可以重复此流程，直到你拼点没赢为止。每阶段限一次。",
	...
	["caizhaoji"] = "蔡昭姬",
	["guihan"] = "归汉",
	[":guihan"] = "出牌阶段，你可以弃置两张相同花色的红色手牌选择一名其他角色，你与该角色交换位置。每阶段限一次",
	["caizhaoji_hujia"] = "胡笳",
	...
	["jiangboyue"] = "姜伯约",
	["lexue"] = "乐学",
	[":lexue"] = "出牌阶段，你可以令一名其他角色展示一张手牌：若该牌为基本牌或非延时类锦囊牌，你可以将与该牌同花色的牌当作该牌使用或打出直到回合结束；否则，你获得该牌。每阶段限一次",
	["xunzhi"] = "殉志",
	...
	["toudu"] = "偷渡",
	[":toudu"] = "当你收到一次伤害后，若你的武将牌背面向上，你可以弃置一张手牌并将你的武将牌翻面，视为对一名其他角色使用了一张【杀】。",
