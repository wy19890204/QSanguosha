...
◆所列出的牌为你可以获得的牌，双击这些牌可以从列表中移除，点击确定为获得所列出的牌。",
	["jiushi"] = "酒诗",
	...
	["#HuileiThrow"] = "%from 的技能【%arg】被触发，杀死马谡的 %to 弃置所有的牌",
...
◆每当你使用锦囊牌造成伤害时（即伤害来源为你），你防止此伤害；每当你受到锦囊牌对你造成的伤害时，你防止此伤害；其他角色对你使用【决斗】，当你对其造成伤害时，你防止此伤害。",
	...
	["#WuyanBad"] = "%from 的技能【%arg2】被触发，防止此伤害",
	["#WuyanGood"] = "%from 的技能【%arg2】被触发，防止此伤害",
...
◆你发动【旋风】须选择一名目标角色，然后依次弃置其两张牌，或选择两名目标角色，然后弃置他们的各一张牌。",
	...
	["#GanluSwap"] = "%from 发动技能【甘露】交换了 %to 之间的装备",
	...
	["@xianzhen-slash"] = "你可以对陷阵目标不限次数的出杀",
...
◆目标角色先选择一项，如果是选择执行第一项效果，你再选择该角色使用【杀】的目标（可以是你）。特别的，若目标角色攻击范围内没有其他角色，其必须选择执行第二项效果进行响应。",
	...
	["mingce:draw"] = "摸一张牌",
	["#ZhichiDamaged"] = "%from 的技能【智迟】被触发，本回合内【杀】和非延时锦囊都将对其无效",
	["#ZhichiAvoid"] = "%from 的技能【智迟】被触发，【杀】和非延时锦囊对其无效",
...
◆权是移出游戏的牌。",
	...
	["#ZiliWake"] = "%from 的“权”的数量达到 %arg 个，触发【%arg2】",
	["zili:draw"] = "摸两张牌",
	["zili:recover"] = "回复1点体力",
	["paiyi"] = "排异",
