...
return {
	...
	["@guidao-card"] = "是否发动【%dest】修改 %src 的 %arg 判定",
	["~guidao"] = "选择一张黑色牌→点击确定",
	["huangtian"] = "黄天",
...
◆你受到一张牌对你造成的伤害时发动【天香】转移的是伤害而不是牌，因此不需要进行使用结算，直接进行伤害结算。",
	...
	["#HongyanJudge"] = "%from 的技能【红颜】被触发， 判定牌由黑桃变成了红桃",
	["hongyan"] = "红颜",
...
◆置于你的武将牌上的牌是移出游戏的牌。",
	["#BuquDuplicate"] = "%from 不屈牌中有 %arg 重复点数",
...
◆当前的体力值为0的角色不能质疑。",
	["guhuo_pile"] = "蛊惑牌堆",
	["#Guhuo"] = "%from 发动了技能【%arg2】，据说这张牌是 %arg，选择的目标为 %to",
	["#GuhuoNoTarget"] = "%from 发动了技能【%arg2】，据说这张牌是 %arg",
