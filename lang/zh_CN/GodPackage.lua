...
◆你死亡时没有任何一名角色拥有梦魇标记，则不会触发【武魂②】。",
	["@nightmare"] = "梦魇",
	["#WuhunRevenge"] = "%from 的技能【%arg2】被触发，持有最多梦魇标记(%arg个)的角色 %to 死亡",
...
◆星是移出游戏的牌。",
	...
	["#QixingExchange"] = "%from 发动了技能【%arg2】交换了 %arg 张手牌。",
	["#FogProtect"] = " 【大雾】被触发，%from防止了 %arg 点[%arg2]伤害。",
	["#GalePower"] = "【狂风】被触发，%from 受到的火焰伤害从 %arg 点增加到 %arg2 点。",
       ["~dawu"] = "选译若干名角色→点击确定→然后在七星堆中选译若干张牌",
	["~kuangfeng"] = "选译一名角色→点击确定→然后在七星堆中选译一张牌",
...
◆目标角色的防具无效即任何时候在任何情况下该角色都不可以发动/不会触发其防具。",
	...
	["#KuangbaoDamage"] = "%from 的技能【%arg2】被触发, %from 获得 %arg 枚“暴怒”标记。",
	["#KuangbaoDamaged"] = "%from 的技能【%arg2】被触发, %from 获得 %arg 枚“暴怒”标记。",
...
◆【鬼才】、【放逐】、【集智】在对应的发动时机弃一枚忍标记发动一次；【制衡】和【完杀】各只能于每个回合出牌阶段的空闲时间点弃忍标记发动一次（【完杀】的效果持续到发动回合的结束）。",
	["#BaiyinWake"] = "%from 的“忍”标记达到 %arg 个(大于或等于4)，触发【拜印】",
	["jilve"] = "极略",
...
-- CV
	...
	["$qinyin1"] = "（琴声）",
	["$qinyin2"] = "（琴声）",
	["$yeyan3"] = "让这熊熊业火，焚尽你的罪恶！",
	["$yeyan2"] = "聆听吧，这首献给你的镇魂曲！",
	["$yeyan1"] = "（琴声）",
